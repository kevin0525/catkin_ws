...
if("TRUE" STREQUAL "TRUE")
  set(talker_SOURCE_PREFIX /home/kevin/workspace/catkin_ws/src/talker)
  set(talker_DEVEL_PREFIX /home/kevin/workspace/catkin_ws/devel)
  set(talker_INSTALL_PREFIX "")
  set(talker_PREFIX ${talker_DEVEL_PREFIX})
else()
  set(talker_SOURCE_PREFIX "")
  set(talker_DEVEL_PREFIX "")
  set(talker_INSTALL_PREFIX /home/kevin/workspace/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${talker_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'talker' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'talker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kevin/workspace/catkin_ws/src/talker/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${talker_dep}_FOUND)
      find_package(${talker_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${talker_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(talker_INCLUDE_DIRS ${${talker_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(talker_LIBRARIES ${talker_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${talker_dep}_LIBRARIES})
  _list_append_deduplicate(talker_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(talker_LIBRARIES ${talker_LIBRARIES})
